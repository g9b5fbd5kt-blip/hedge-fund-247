...
# TRADING PARAMETERS - OPTIMIZED FOR $1,007 CAPITAL
...
SELL_SCORE_MAX = 25
MAX_POSITIONS = 10
RISK_PER_TRADE = 0.005 # 0.5% - User constraint

# 54 CORE PHRASES - From your code
CORE_PHRASES = [
...
tg = Bot(token=TG_TOKEN) if TG_TOKEN else None
